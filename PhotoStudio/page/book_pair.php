...
<body>
    ...
    <div class="container">
        <div class="photo-section-first">
            <img src="../Photos/Pair.jpg" alt="Solo Photo" class="photo">
            <div class="details">
                <h3>Pair Package</h3>
                <p>₱700.00</p>
                <ul>
                    <li>30-minute photoshoot for two person</li>
        ...
        <div class="photo-section">
            <div class="details-forms">
                <form class="appointment-form" action = "../function/payment_pair.php" method = "POST">
                    <div class="column">
