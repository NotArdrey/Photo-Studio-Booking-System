...
<body>
    ...
    <div class="container">
        <div class="photo-section-first">
            <img src="../Photos/soloPackage.jpg" alt="Solo Photo" class="photo">
            <div class="details">
                <h3>Solo Package</h3>
                <p>₱500.00</p>
                <ul>
                    <li>30-minute photoshoot for one person</li>
        ...
        <div class="photo-section">
            <div class="details-forms">
                <form class="appointment-form" action= "../function/payment_solo.php" method = "POST">
                    <div class="column">
                ...
                <div class="btn">
                    <button type="submit" name = "submit-btn"class="styled-button">
                        Pay Downpayment
                    </button>
                </div>
            </div>
